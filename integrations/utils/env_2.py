...
MONGODB_URI = os.getenv("MONGODB_URI", "mongodb+srv://camilonarvaez:KPhUAtVXocsIQjit@demo-cluster.udlvg.mongodb.net/")
DB_NAME = os.getenv("DB_NAME", "veridic_rag")
...
KB_NAME = os.getenv("KB_NAME", "veridic")